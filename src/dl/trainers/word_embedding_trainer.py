...
class PretrainedWordEmbeddingTrainer(BaseTrainer):
    def train(self, X_train, y_train, X_valid, y_valid, word_embedding_model):
        train_loader = get_pretrained_word_embedding_data_loader(X_train, y_train, word_embedding_model, self.batch_size)
        valid_loader = get_pretrained_word_embedding_data_loader(X_valid, y_valid, word_embedding_model, self.batch_size)
